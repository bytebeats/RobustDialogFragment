...
public class RobustDialogFragment extends Fragment
    ...
    private DialogInterface.OnCancelListener mOnCancelListener = new OnCancelWeaklyReachableListener(this);
    private DialogInterface.OnDismissListener mOnDismissListener = new OnDismissWeaklyReachableListener(this);
            ...
            if (lifecycleOwner != null && mShowsDialog) {
                ...
                if (view.getParent() != null) {
                    throw new IllegalStateException(
                            "RobustDialogFragment can not be attached to a container view");
                }
                if (mDialog != null) {
                    if (FragmentManager.isLoggingEnabled(Log.DEBUG)) {
                        Log.d(TAG, "RobustDialogFragment " + this + " setting the content view on "
                                + mDialog);
                    }
     ...
     * class MyDialogFragment extends RobustDialogFragment {
     ...
     *
     * @see #RobustDialogFragment()
     * @see #onCreateView(LayoutInflater, ViewGroup, Bundle)
     */
    public RobustDialogFragment(@LayoutRes int contentLayoutId) {
    ...
    public void setStyle(@DialogStyle int style, @StyleRes int theme) {
        if (FragmentManager.isLoggingEnabled(Log.VERBOSE)) {
            Log.d(TAG, "Setting style and theme for RobustDialogFragment " + this + " to " + style
                    + ", " + theme);
        }
        mStyle = style;
    ...
    public final Dialog requireDialog() {
        ...
        if (dialog == null) {
            throw new IllegalStateException("RobustDialogFragment " + this + " does not have a Dialog.");
        }
        return dialog;
    }
     ...
     * Dialog.setCancelable(boolean)}, because RobustDialogFragment needs to change
    ...
    FragmentContainer createFragmentContainer() {
        ...
        return new FragmentContainer() {
            ...
            public View onFindViewById(int id) {
                ...
                return RobustDialogFragment.this.onFindViewById(id);
            }

            @Override
            public boolean onHasView() {
                return  fragmentContainer.onHasView() || RobustDialogFragment.this.onHasView();
            }
        };
    }
    ...
    public LayoutInflater onGetLayoutInflater(@Nullable Bundle savedInstanceState) {
        ...
        if (!mShowsDialog || mCreatingDialog) {
            if (FragmentManager.isLoggingEnabled(Log.VERBOSE)) {
                String message = "getting layout inflater for RobustDialogFragment " + this;
                if (!mShowsDialog) {
        ...
        if (FragmentManager.isLoggingEnabled(Log.VERBOSE)) {
            Log.d(TAG, "get layout inflater for RobustDialogFragment " + this + " from dialog context");
        }
     ...
     * class.
     *
     * <p><em>Note: RobustDialogFragment own the {@link Dialog#setOnCancelListener
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        if (FragmentManager.isLoggingEnabled(Log.DEBUG)) {
            Log.d(TAG, "onCreateDialog called for RobustDialogFragment " + this);
        }
    ...
    public void onDismiss(@NonNull DialogInterface dialog) {
        if (!mViewDestroyed) {
            ...
            if (FragmentManager.isLoggingEnabled(Log.DEBUG)) {
                Log.d(TAG, "onDismiss called for RobustDialogFragment " + this);
            }
